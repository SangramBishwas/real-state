    ...
    return (
        <div className="m-5 lg:mx-32 lg:my-16">
            ...
            <div className="flex flex-col-reverse lg:flex-row gap-7 mt-10">
                <div className="bg-[#00d16926] flex items-center flex-col lg:flex-row hover:bg-orange-600 hover:text-white transition duration-300 hover:ease-in-out gap-7 p-7">
                ...
                <div className="bg-[#F8FAFC] flex items-center flex-col lg:flex-row hover:bg-blue-800 hover:text-white transition duration-300 hover:ease-in-out gap-7 p-7">
