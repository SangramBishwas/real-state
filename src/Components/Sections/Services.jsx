...
const Services = () => {
    return (
        <div className="m-5 lg:mx-32 lg:my-16">
            <h2 className="text-center text-3xl font-semibold">Our Services</h2>
            <div className="flex flex-col-reverse lg:flex-row gap-7 mt-10">
                <div className="animate__animated animate__fadeInLeft bg-[#00d16926] flex items-center flex-col lg:flex-row hover:bg-orange-600 hover:text-white transition duration-300 hover:ease-in-out gap-7 p-7">
                ...
                <div className="animate__animated animate__fadeInTopRight bg-[#F8FAFC] flex items-center flex-col lg:flex-row hover:bg-blue-800 hover:text-white transition duration-300 hover:ease-in-out gap-7 p-7">
            ...
            <div className="flex flex-col lg:flex-row gap-7 mt-7">
                <div className="animate__animated animate__fadeInLeft bg-[#F8FAFC] flex items-center flex-col lg:flex-row hover:bg-blue-800 hover:text-white transition duration-300 hover:ease-in-out gap-7 p-7">
                ...
                <div className="animate__animated animate__fadeInTopRight bg-[#00d16926] flex items-center flex-col lg:flex-row hover:bg-orange-600 hover:text-white transition duration-300 hover:ease-in-out gap-7 p-7">
